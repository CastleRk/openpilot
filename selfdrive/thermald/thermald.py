...
DAYS_NO_CONNECTIVITY_MAX = 28  # do not allow to engage after a 4 weeks without internet
DAYS_NO_CONNECTIVITY_PROMPT = 21  # send an offroad prompt after 3 weeks with no internet
